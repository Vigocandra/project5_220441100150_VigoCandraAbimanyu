...
//    boolean ini=true;
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon("C:\\Users\\BIMA\\OneDrive\\Dokumen\\13.png")); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(bhapus, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(bhapus, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                            .addComponent(bsimpan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\BIMA\\OneDrive\\Dokumen\\11.jpg")); // NOI18N
        jLabel2.setText("k");
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        try{
            ...
            System.out.println(e.getMessage());
             ...
             try{
            String update ="UPDATE tb_datapenjualan SET harga_barang='"+harga+"',kembalian='"+kembali+"',nama_barang='"+barang+"',jumlah_beli='"+beli+"',total_harga='"+total_harga+"',total_bayar='"+bayar+"',nama_pembeli='"+txtnamapembeli.getText()+"' where kode_barang='"+kode+"'";
            java.sql.Connection conn=(java.sql.Connection)prakt5.koneksi.koneksiDB();    
            java.sql.PreparedStatement 
...
//        if (ini==false){
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
         if(data==null){
            ...
            if(jawab==0){
               try{
               String sql="delete from tb_datapenjualan where nama_pembeli ='"+txtnamapembeli.getText()+"'";
               java.sql.Connection conn=(java.sql.Connection)prakt5.koneksi.koneksiDB();
               java.sql.PreparedStatement 
               pst=conn.prepareStatement(sql);
               pst.execute();
